...
class Onscreen4 extends StatefulWidget {
  const Onscreen4({Key? key}) : super(key: key);

  @override
  State<Onscreen4> createState() => _Onscreen4State();
}

class _Onscreen4State extends State<Onscreen4> {
                            ...
                            children: [
                              Container(
                                ...
                                child: const CircleAvatar(
                                  backgroundImage: AssetImage('asset/s1.png'),
                                  radius: 10,
                                ),),
                              Container(
                                width: 70,
                                height: 70,
                                child: const CircleAvatar(
                                  backgroundImage: AssetImage('asset/s2.png'),
                                  radius: 10,
                                ),),
                              Container(
                                width: 70,
                                height: 70,
                                child: const CircleAvatar(
                                  backgroundImage: AssetImage('asset/s3.png'),
                                  radius: 10,
                                ),),
                              Container(
                                width: 70,
                                height: 70,
                                child: const CircleAvatar(
                                  backgroundImage: AssetImage('asset/s4.png'),
                                  radius: 10,
                                ),),
                              Container(
                                width: 70,
                                height: 70,
                                child: const CircleAvatar(
                                  backgroundImage: AssetImage('asset/s5.png'),
                                  radius: 10,
                                ),),
                            ],
                          ),
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: Colors.white,
                                      image:  DecorationImage(image: AssetImage(sports[index].image),
                                          fit: BoxFit.cover),
