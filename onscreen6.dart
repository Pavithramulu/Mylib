...
class Onscreen6 extends StatefulWidget {
  const Onscreen6({Key? key}) : super(key: key);

  @override
  State<Onscreen6> createState() => _Onscreen6State();
}

class _Onscreen6State extends State<Onscreen6> {
                            ...
                            children: [
                              Container(
                                ...
                                child: const CircleAvatar(
                                  backgroundImage: AssetImage('asset/a1.png'),
                                  radius: 10,
                                ),),
                              Container(
                                width: 70,
                                height: 70,
                                child: const CircleAvatar(
                                  backgroundImage: AssetImage('asset/a2.png'),
                                  radius: 10,
                                ),),
                              Container(
                                width: 70,
                                height: 70,
                                child: const CircleAvatar(
                                  backgroundImage: AssetImage('asset/a3.png'),
                                  radius: 10,
                                ),),
                              Container(
                                width: 70,
                                height: 70,
                                child: const CircleAvatar(
                                  backgroundImage: AssetImage('asset/a4.png'),
                                  radius: 10,
                                ),),
                              Container(
                                width: 70,
                                height: 70,
                                child: const CircleAvatar(
                                  backgroundImage: AssetImage('asset/a5.png'),
                                  radius: 10,
                                ),),
                            ],
                          ),
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: Colors.white,
                                      image:  DecorationImage(image: AssetImage(chennal[index].image),
                                          fit: BoxFit.cover),
