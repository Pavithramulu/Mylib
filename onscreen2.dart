...
class Onscreen2 extends StatefulWidget {
  const Onscreen2({Key? key}) : super(key: key);

  @override
  State<Onscreen2> createState() => _Onscreen2State();
}

class _Onscreen2State extends State<Onscreen2> {
                            ...
                            children: [
                              Container(
                                ...
                                child: const CircleAvatar(
                                  backgroundImage: AssetImage('asset/devil1.png'),
                                  radius: 10,
                                ),),
                              Container(
                                width: 70,
                                height: 70,
                                child: const CircleAvatar(
                                  backgroundImage: AssetImage('asset/devil2.png'),
                                  radius: 10,
                                ),),
                              Container(
                                width: 70,
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: Colors.white,
                                      image:  DecorationImage(image: AssetImage(horor[index].image),
                                          fit: BoxFit.cover),
