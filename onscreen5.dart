...
class Onscreen5 extends StatefulWidget {
  const Onscreen5({Key? key}) : super(key: key);

  @override
  State<Onscreen5> createState() => _Onscreen5State();
}

class _Onscreen5State extends State<Onscreen5> {
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: Colors.white,
                                      image:  DecorationImage(image: AssetImage(movei[index].image),
                                          fit: BoxFit.cover),
